...
class CaptureManager:
    ...
    def _command(
        ...
        command = [
            ...
            f"gripper_state_topic:={payload.get('gripper_state_topic', '/robotiq_2f_gripper/joint_states')}",
            f"gripper_state_msg_type:={payload.get('gripper_state_msg_type', 'sensor_msgs.msg:JointState')}",
